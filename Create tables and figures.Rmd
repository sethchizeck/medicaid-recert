...
basic_model <- feols(medicaid_enrolled ~ treat | person_deadline_id, 
...
event_study <- feols(medicaid_enrolled ~ i(tau_week, ref = -1) | person_deadline_id,
...
basic_model <- feols(had_er_visit ~ treat | person_deadline_id, 
                     data = dt,
                     cluster = "mci_uniq_id")  
...
event_study <- feols(had_er_visit ~ i(tau_week, ref = -1) | person_deadline_id,
                     data = dt,
                     cluster = "mci_uniq_id")
