...
# Reshape the data to have 1 obs for each week during each enrollment episode in any level of CHIP (ignore the cost-sharing tier info here)
  ...
  mutate(chip_enrolled = 1,
         calendar_week = as.numeric(floor(difftime(date, as.Date('2022-01-01'), units = "weeks"))) + 1) 
...
# Lisa Kessler says I am not allowed to view this data, but I can send her my analytic data set and she can merge in the outcomes from this data and run my code. 
```
