...
#-------------------------------------------------------------------------
# Remove any recertification deadlines that were >=2 deadlines into the future at the time the person left Medicaid
...
sample_recert_deadlines <- sample_recert_deadlines %>%
  ...
  ungroup() %>%
  arrange(ma_receipt_num, recert_deadline) %>%
